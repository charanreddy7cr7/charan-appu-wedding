...
const codes = [
  ...
  { event: "Reception",  emoji: "🎉", theme: "Black", swatches: ["#2B1B3D", "#000000", "#3A2C4D"], color: "#2B1B3D" },
];

export default function DressCodeSection() {
  return (
    <section id="dresscode" className="py-20 px-6 relative" style={{ background: "#FFF8F0" }}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {codes.map((c, i) => (
            <motion.div key={c.event}
              ...
              <h3 style={{ fontFamily: "'Fraunces', serif", fontWeight: 600, fontSize: "1.15rem", color: "#2B1B3D", marginTop: "0.4rem" }}>
                {c.event}
              </h3>
