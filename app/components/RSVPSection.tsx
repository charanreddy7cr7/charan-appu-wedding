...
export default function RSVPSection() {
  ...
  return (
    <section
      ...
      style={{ background: "linear-gradient(180deg, #FFFFFF 0%, #FBF6EC 50%, #EFE6D2 100%)" }}
    >
      ...
      <div className="relative z-10 max-w-2xl mx-auto">
        ...
        >
          <p style={{ color: "#7A5A2E", fontFamily: "'Lato', sans-serif", fontWeight: 600,
          ...
          {/* New prompt text */}
          <p style={{ color: "#4A3728", fontFamily: "'Cormorant Garamond', serif",
            ...
            <br />
            <em style={{ color: "#7A5A2E" }}>
              Come and bless us — your presence makes us more happy.
            </em>
          </p>

          <p style={{ color: "#9C8460", fontFamily: "'Lato', sans-serif", fontWeight: 400,
            fontSize: "0.75rem", letterSpacing: "0.1em", marginTop: "1rem" }}>
            Please respond by <strong style={{ color: "#7A5A2E" }}>October 1, 2026</strong>
          </p>
        </motion.div>
