    ...
    <section id="rsvp" className="py-20 px-4 sm:px-6 relative overflow-hidden" style={{ background: "#FFF1F6" }}>
      ...
      <div className="relative z-10 max-w-2xl mx-auto">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-10">
          <p style={{ fontFamily: "'Poppins', sans-serif", fontWeight: 600, fontSize: "0.75rem", letterSpacing: "0.2em", color: "#E63980", textTransform: "uppercase" }}>
            Apoorva &amp; Charan
          </p>
          <h2 className="festive-text mt-2" style={{ fontFamily: "'Fraunces', serif", fontWeight: 600, fontSize: "clamp(2.2rem, 6vw, 3.6rem)" }}>
            Will you join us?
          </h2>
            ...
            <motion.form key="form" initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }}
              ...
              <div className="text-center pt-2">
                ...
                <motion.button type="submit" disabled={submitState === "submitting"}
                  ...
                  {submitState === "submitting" ? "Sending… 🎈" : "Send our RSVP 🎉"}
                </motion.button>
                {submitState === "error" && (
                  <p className="mt-4" style={{ color: "#E63946", fontFamily: "'Poppins', sans-serif", fontSize: "0.85rem" }}>
                    Something went wrong. Please try again or email us directly.
                  </p>
                )}
                <p className="mt-4" style={{ fontFamily: "'Poppins', sans-serif", fontSize: "0.72rem", color: "#9585A5" }}>
